  ...
  <div>
    ...
    <div class="mt-4">
      <NScrollbar
        ...
        style="max-height: 550px; width: 50%"
        trigger="hover"
      >
      ...
      >
        ...
        <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
          <li>
            ...
            >
              <div
                class="mr-3 mb-3 w-12 h-12 rounded-full sm:mb-0 border-amber-200"
              >
                6
              </div>
...
let data = ref([
  ...
  { date: "2022-09-13", user: "Usuário 1", widget: "login page", vote: 5 },
  {
    ...
    vote: 5,
    comment:
      "Plataforma trava muito, então sugiro que seja feito uma alteração assim, e bla bla bla bla ",
  },
  { date: "2022-09-13", user: "Usuário 1", widget: "login page", vote: 5 },
  { date: "2022-09-13", user: "Usuário 1", widget: "login page", vote: 5 },
...
const search = () => {
  ...
  data.value = data.value.filter((item) =>
    item.user.includes(searchTerm.value.toLowerCase())
  );
};
